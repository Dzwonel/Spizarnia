...
DEFAULT_UNIT_ENTRIES = [
    {"name": "sztuki", "adjustable": True},
    {"name": "g", "adjustable": False},
    {"name": "Kg", "adjustable": False},
    {"name": "L", "adjustable": False},
    {"name": "ml", "adjustable": False},
    {"name": "pudełko", "adjustable": False},
    {"name": "pudełek", "adjustable": False},
]
...
DISPLAYABLE_FIELDS = [
    ...
    {"key": "bin_number", "label": "Pojemnik", "sort_type": "text"},
    {"key": "category", "label": "Kategoria", "sort_type": "text"},
    {"key": "quantity", "label": "Ilość", "sort_type": "number"},
    {"key": "unit", "label": "Jednostka", "sort_type": "text"},
    {"key": "condition", "label": "Stan", "sort_type": "text"},
    {"key": "origin_date", "label": "Data pochodzenia", "sort_type": "text"},
    {"key": "use_by_date", "label": "Data przydatności", "sort_type": "text"},
    {"key": "use_within", "label": "Spożyć w ciągu", "sort_type": "text"},
    {"key": "tags", "label": "Tagi", "sort_type": "text"},
    {"key": "last_audit_date", "label": "Ostatnia aktualizacja", "sort_type": "text"},
    {"key": "barcode", "label": "Kod kreskoty", "sort_type": "text"},
    {"key": "serial_number", "label": "Numer seryjny", "sort_type": "text"},
    {"key": "second_serial_number", "label": "Identyfikator śledzenia podpozycji", "sort_type": "text"},
